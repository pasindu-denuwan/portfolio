/**
 * Starfield Close — Three.js GPU Starfield Tunnel & Atmosphere
 * Recreated with exact r0.143.0 shaders, postprocessing pipeline, and pointer/scroll dynamics.
 */
...
const canvas = document.getElementById('scene') || (() => {
  ...
  c.id = 'scene';
  c.style.cssText = 'position:fixed; inset:0; width:100vw; height:100vh; display:block; z-index:-1; pointer-events:none;';
...
// Double-damped Scroll & Mouse Parallax
let scrollTarget = 0;
let scrollSmooth = 0;
let scrollCurrent = 0;
...
function animate() {
  ...
  uDriftAcc += dt * (CONFIG.drift + scrollCurrent * CONFIG.scrollDrift);
  starMaterial.uniforms.uDrift.value = uDriftAcc;

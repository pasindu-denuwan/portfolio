    ...
    <section id="home" className="min-h-screen flex items-center justify-center pt-20 px-6 md:px-12 relative z-10">
      <div className="max-w-7xl w-full grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <h2 className="text-xl md:text-2xl font-medium text-accent mb-4">Data & Technology Enthusiast | Undergraduate</h2>
          ...
          <div className="flex flex-wrap gap-4 mt-4">
            ...
            <a href="/portfolio/resume.pdf" target="_blank" className="border border-primary/40 px-6 py-3 flex items-center gap-2 hover:bg-primary/20 transition-colors text-accent font-medium rounded-xl">
